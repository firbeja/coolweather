...
//            String weather_id = getIntent().getStringExtra("weather_id");
    ...
    /**
     * 根据天气 id 请求城市天气信息
     * http://guolin.tech/api/weather?cityid=CN101190401&key=096b7ea4bef14ed682d80c8031715039
     */
    public void requestWeather(String weather_id) {

        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weather_id + "&key=096b7ea4bef14ed682d80c8031715039";
